...
pokedexWindow::pokedexWindow()
{
    ...
    loadTrainer->setGeometry(250, 120, 150, 50);
    loadTrainer->setToolTip("Load a trainer.");
    loadTrainer->setStyleSheet("background-color: brown;");
...
{
    QString fichier = QFileDialog::getSaveFileName(this, "Enregistrer l'equipe", QString(), "Equipes (*.xml)");
}

void    pokedexWindow::loadPokemonTrainer()
{
    QString fichier = QFileDialog::getOpenFileName(this, "Enregistrer l'equipe", QString(), "Trainer (*.xml)");
}

void    pokedexWindow::loadPokemonTeam()
{
    QString fichier = QFileDialog::getOpenFileName(this, "Enregistrer l'equipe", QString(), "Equipes (*.xml)");
}
